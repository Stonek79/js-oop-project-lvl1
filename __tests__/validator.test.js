...
describe('Validators:', () => {
  test('string', () => {
    ...
    schema.minLength(11);
    expect(schema.isValid('normal length')).toBe(true);
    expect(schema.isValid('min length')).toBe(false);
  ...
  test('shape (object)', () => {
    ...
    expect(schema.isValid({ car: 'mersedes', year: '1909', models: ['benz'] })).toBe(false);
